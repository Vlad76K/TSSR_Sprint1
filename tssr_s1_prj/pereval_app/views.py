...
"""
закоментирована часть импортов, использовавшаяся для визуальных процедур - нецелевые наработки
"""
...
""" Визуальные представления - вывод данных в html-шаблон (использовались для контрольных мероприятий проверки базы) """
""" сохранение данных об объекте, авторе, статусе, координатах (не API) """
""" сохранение данных об объекте (не API) """
# @method_decorator(csrf_exempt, name='dispatch')
